...
public class SharedPrefs {
    ...
    public static void setUserList(HashMap<Integer, UserModel> itemList) {

        Gson gson = new Gson();
        String json = gson.toJson(itemList);
        preferenceSetter("userList", json);
    }

    public static HashMap getUserLis() {
        Gson gson = new Gson();

        HashMap<Integer, Object> retMap = new Gson().fromJson(
                preferenceGetter("userList"), new TypeToken<HashMap<Integer, Object>>() {
                }.getType()
        );
